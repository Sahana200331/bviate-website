      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="https://wa.me/918881888321?text=Hi%2C%20I%20found%20you%20on%20bviatesolutions.com%20and%20wanted%20to%20know%20more." target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-white text-sm transition-colors">WhatsApp</a>
          </div>
